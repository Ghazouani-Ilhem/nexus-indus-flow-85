...
// Import hero images
const opcConnectivityImage = '/assets/3d-opc-connectivity.jpg';
const iotNetworkImage = '/assets/3d-iot-network.jpg';
const opcUANetworkImage = '/assets/opc-ua-network.jpg';
const enhancedOpcConnectors = '/assets/enhanced-opc-connectors.jpg';
const enhancedOpcUAServer = '/assets/enhanced-opc-ua-server.jpg';
